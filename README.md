...
> Так створення нових об'єктів необхідно делегувати з базового класу класів спадкоємцям, а також при майбутньому розширенні було зручніше вносити нові класи, даний паттерн потрібно застосувати для розширення классу PaymentMethod класами спадкоємцями BankTransferPayment, CreditCardPayment, PayPalPayment. 
